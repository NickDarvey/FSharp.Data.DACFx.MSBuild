...
let CompileConnectionStringA =
    @"Data Source=(LocalDb)\MSSQLLocalDB;Initial Catalog=SampleDatabase;Integrated Security=True"
...
[<EntryPoint>]
let main argv =
    let runtimeA = @"Data Source=(LocalDb)\MSSQLLocalDB;Initial Catalog=SampleDatabaseRuntime;Integrated Security=True"
